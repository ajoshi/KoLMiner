...
void main() {
  group('Empty mine tests', () {
    ...
    test(
        'getNextMineableSquare is null if mine is list empty and many squares mined',
        () {
  ...
  group('Mine with shinies', () {
    test(
        'getNextMineableSquare does not return shiny in 4th row if we can still mine in first 2 rows',
        () {
      var mine = Mine([
        MineableSquare("a", true, 1, 4),
        MineableSquare("b", true, 2, 5),
        MineableSquare("c", true, 3, 6)
      ], true, 10);
    ...
    test(
        'getNextMineableSquare does not return shiny in 5th row if we can still mine in 6th row',
        () {
      var mine = Mine(
          [MineableSquare("b", true, 2, 5), MineableSquare("c", true, 3, 6)],
          true,
          10);
    ...
    test(
        'getNextMineableSquare does not return shiny in 4th row if we mined under 6 squares',
        () {
      var mine = Mine([MineableSquare("a", true, 1, 4)], true, 5);

      expect(mine.getNextMineableSquare(), isNull);
    });

    test(
        'getNextMineableSquare does not return shiny in 4th row if we mined 0 squares',
        () {
      var mine = Mine([MineableSquare("a", true, 1, 4)], true, 0);
    ...
    test('getNextMineableSquare returns shiny in 6th row if we mined 0 squares',
        () {
      var mine = Mine([MineableSquare("a", true, 1, 6)], true, 0);
    ...
    test(
        'getNextMineableSquare returns shiny in 6th row if we mined 10 squares',
        () {
      var mine = Mine([MineableSquare("a", true, 1, 6)], true, 10);
